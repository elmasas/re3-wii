...
int32 CControllerConfigManager::GetJoyButtonJustDown()
{
	...
	if (triggerButtons & PAD_BUTTON_A)
		return 2;
	else if (triggerButtons & PAD_BUTTON_B)
		return 1;
	else if (triggerButtons & PAD_BUTTON_X)
		return 3;
	else if (triggerButtons & PAD_BUTTON_Y)
		return 4;
	else if (triggerButtons & PAD_TRIGGER_Z)
		return 7;
	else if (triggerButtons & PAD_BUTTON_START)
		return 12;
	else if (triggerButtons & PAD_BUTTON_UP)
		return 13;
	else if (triggerButtons & PAD_BUTTON_RIGHT)
		return 14;
	else if (triggerButtons & PAD_BUTTON_DOWN)
		return 15;
	else if (triggerButtons & PAD_BUTTON_LEFT)
		return 16;
	else if (triggerButtons & PAD_TRIGGER_L)
		return 5;
...
void CControllerConfigManager::UpdateJoyButtonState(int32 padnumber)
{
	...
	if (heldButtons & PAD_BUTTON_A)
		m_aButtonStates[1] = 1;
	if (heldButtons & PAD_BUTTON_B)
		m_aButtonStates[0] = 1;
	if (heldButtons & PAD_BUTTON_X)
		m_aButtonStates[2] = 1;
	if (heldButtons & PAD_BUTTON_Y)
		m_aButtonStates[3] = 1;
	if (heldButtons & PAD_TRIGGER_Z)
		m_aButtonStates[6] = 1;
	if (heldButtons & PAD_BUTTON_START)
		m_aButtonStates[11] = 1;
	if (heldButtons & PAD_BUTTON_UP)
		m_aButtonStates[12] = 1;
	if (heldButtons & PAD_BUTTON_RIGHT)
		m_aButtonStates[13] = 1;
	if (heldButtons & PAD_BUTTON_DOWN)
		m_aButtonStates[14] = 1;
	if (heldButtons & PAD_BUTTON_LEFT)
		m_aButtonStates[15] = 1;
	if (heldButtons & PAD_TRIGGER_L)
		m_aButtonStates[4] = 1;
