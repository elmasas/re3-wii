...
RawMatrix::mult(RawMatrix *dst, RawMatrix *src1, RawMatrix *src2)
{
...
#else
    float A00_A01 = psq_l(0, src1, 0, 0);
    float B00_B01 = psq_l(0, src2, 0, 0);
    float D00_D01 = ps_muls0(B00_B01, A00_A01);
    float B02_B03 = psq_l(8, src2, 0, 0);
	float D02_D03 = ps_muls0(B02_B03, A00_A01);
	float A10_A11 = psq_l(16, src1, 0, 0);
	float D10_D11 = ps_muls0(B00_B01, A10_A11);
	float D12_D13 = ps_muls0(B02_B03, A10_A11);
	float A20_A21 = psq_l(32, src1, 0, 0);
	float D20_D21 = ps_muls0(B00_B01, A20_A21);	
	float D22_D23 = ps_muls0(B02_B03, A20_A21);
	float A30_A31 = psq_l(48, src1, 0, 0);
	float D30_D31 = ps_muls0(B00_B01, A30_A31);
	float D32_D33 = ps_muls0(B02_B03, A30_A31);
	float B10_B11 = psq_l(16, src2, 0, 0);
	D00_D01 = ps_madds1(B10_B11, A00_A01, D00_D01);
	float B12_B13 = psq_l(24, src2, 0, 0);
	...
	float B20_B21 = psq_l(32, src2, 0, 0);
	float A02_A03 = psq_l(8, src1, 0, 0);
	D00_D01 = ps_madds0(B20_B21, A02_A03, D00_D01);
	float B22_B23 = psq_l(40, src2, 0, 0);
	D02_D03 = ps_madds0(B22_B23, A02_A03, D02_D03);
	float A12_A13 = psq_l(24, src1, 0, 0);
	D10_D11 = ps_madds0(B20_B21, A12_A13, D10_D11);
	D12_D13 = ps_madds0(B22_B23, A12_A13, D12_D13);
	float A22_A23 = psq_l(40, src1, 0, 0);
	D20_D21 = ps_madds0(B20_B21, A22_A23, D20_D21);
	D22_D23 = ps_madds0(B22_B23, A22_A23, D22_D23);
	float A32_A33 = psq_l(56, src1, 0, 0);
	D30_D31 = ps_madds0(B20_B21, A32_A33, D30_D31);
	D32_D33 = ps_madds0(B22_B23, A32_A33, D32_D33);
	float B30_B31 = psq_l(48, src2, 0, 0);
	D00_D01 = ps_madds1(B30_B31, A02_A03, D00_D01);
	psq_st(D00_D01, 0, dst, 0, 0);
	float B32_B33 = psq_l(56, src2, 0, 0);
	D02_D03 = ps_madds1(B32_B33, A02_A03, D02_D03);
	psq_st(D02_D03, 8, dst, 0, 0);
	D10_D11 = ps_madds1(B30_B31, A12_A13, D10_D11);
	psq_st(D10_D11, 16, dst, 0, 0);
	D12_D13 = ps_madds1(B32_B33, A12_A13, D12_D13);
	psq_st(D12_D13, 24, dst, 0, 0);
	D20_D21 = ps_madds1(B30_B31, A22_A23, D20_D21);
	psq_st(D20_D21, 32, dst, 0, 0);
	D22_D23 = ps_madds1(B32_B33, A22_A23, D22_D23);
	psq_st(D22_D23, 40, dst, 0, 0);
	D30_D31 = ps_madds1(B30_B31, A32_A33, D30_D31);
	psq_st(D30_D31, 48, dst, 0, 0);
	D32_D33 = ps_madds1(B32_B33, A32_A33, D32_D33);
	psq_st(D32_D33, 56, dst, 0, 0);
#endif
}
...
Matrix::mult_(Matrix *dst, const Matrix *src1, const Matrix *src2)
{
	...
	float B00_B01 = psq_l(0, src2, 0, 0);
	float D00_D01 = ps_muls0(B00_B01, A00_A01);
	float B02_B03 = psq_l(8, src2, 1, 0);
	float D02_D03 = ps_muls0(B02_B03, A00_A01);
	float A10_A11 = psq_l(16, src1, 0, 0);
	float D10_D11 = ps_muls0(B00_B01, A10_A11);
	float D12_D13 = ps_muls0(B02_B03, A10_A11);
	...
	float B32_B33 = psq_l(56, src2, 1, 0);
	float D32_D33 = ps_madds0(B02_B03, A30_A31, B32_B33);
	float B10_B11 = psq_l(16, src2, 0, 0);
	D00_D01 = ps_madds1(B10_B11, A00_A01, D00_D01);
	float B12_B13 = psq_l(24, src2, 1, 0);
	D02_D03 = ps_madds1(B12_B13, A00_A01, D02_D03);
	D10_D11 = ps_madds1(B10_B11, A10_A11, D10_D11);
	D12_D13 = ps_madds1(B12_B13, A10_A11, D12_D13);
	D20_D21 = ps_madds1(B10_B11, A20_A21, D20_D21);
	...
	D32_D33 = ps_madds1(B12_B13, A30_A31, D32_D33);
	float B20_B21 = psq_l(32, src2, 0, 0);
	float A02_A03 = psq_l(8, src1, 1, 0);
	D00_D01 = ps_madds0(B20_B21, A02_A03, D00_D01);
	float B22_B23 = psq_l(40, src2, 1, 0);
	D02_D03 = ps_madds0(B22_B23, A02_A03, D02_D03);
	float A12_A13 = psq_l(24, src1, 1, 0);
	D10_D11 = ps_madds0(B20_B21, A12_A13, D10_D11);
	D12_D13 = ps_madds0(B22_B23, A12_A13, D12_D13);
	float A22_A23 = psq_l(40, src1, 1, 0);
	D20_D21 = ps_madds0(B20_B21, A22_A23, D20_D21);
	D22_D23 = ps_madds0(B22_B23, A22_A23, D22_D23);
	float A32_A33 = psq_l(56, src1, 1, 0);
	D30_D31 = ps_madds0(B20_B21, A32_A33, D30_D31);
	D32_D33 = ps_madds0(B22_B23, A32_A33, D32_D33);
	psq_st(D00_D01, 0, dst, 0, 0);
	psq_st(D02_D03, 8, dst, 1, 0);
	psq_st(D10_D11, 16, dst, 0, 0);
	psq_st(D12_D13, 24, dst, 1, 0);
	psq_st(D20_D21, 32, dst, 0, 0);
	psq_st(D22_D23, 40, dst, 1, 0);
	psq_st(D30_D31, 48, dst, 0, 0);
	psq_st(D32_D33, 56, dst, 1, 0);
#endif
}
